$(document).ready(function () {
    ...
    function decodeOnce(codeReader, selectedDeviceId, inputField, resultElement, videoElement, resetButton) {
        ...
        if (resultElement === 'js_id_sh_it_barcode_mobile_result_source_location') {
            video = "video_source_location";
        } else if (resultElement === 'js_id_sh_it_barcode_mobile_result_dest_location') {
    ...
    $("#js_id_sh_it_barcode_mobile_reset_btn_source_location").hide();
    $("#js_id_sh_it_barcode_mobile_reset_btn_dest_location").hide();
    ...
    initializeCameraSelection(codeReaderMain, "js_id_sh_it_barcode_mobile_cam_select");
    initializeCameraSelection(codeReaderSource, "js_id_sh_it_barcode_mobile_cam_select_source_location");
    initializeCameraSelection(codeReaderDestination, "js_id_sh_it_barcode_mobile_cam_select_dest_location");
    ...
    setupEventHandlers(
        codeReaderMain,
        'input[name="sh_it_barcode_mobile"]',
        "#js_id_sh_it_barcode_mobile_start_btn",
        "#js_id_sh_it_barcode_mobile_reset_btn",
        "#js_id_sh_it_barcode_mobile_vid_div",
        "js_id_sh_it_barcode_mobile_result",
        "js_id_sh_it_barcode_mobile_cam_select"
    );

    setupEventHandlers(
        codeReaderSource,
        'input[name="source_location_barcode"]',
        "#js_id_sh_it_barcode_mobile_start_btn_source_location",
        "#js_id_sh_it_barcode_mobile_reset_btn_source_location",
        "#js_id_sh_it_barcode_mobile_vid_div_source_location",
        "js_id_sh_it_barcode_mobile_result_source_location",
        "js_id_sh_it_barcode_mobile_cam_select_source_location"
    );

    setupEventHandlers(
        codeReaderDestination,
        'input[name="destination_location_barcode"]',
        "#js_id_sh_it_barcode_mobile_start_btn_dest_location",
        "#js_id_sh_it_barcode_mobile_reset_btn_dest_location",
        "#js_id_sh_it_barcode_mobile_vid_div_dest_location",
        "js_id_sh_it_barcode_mobile_result_dest_location",
        "js_id_sh_it_barcode_mobile_cam_select_dest_location"
    );
});
