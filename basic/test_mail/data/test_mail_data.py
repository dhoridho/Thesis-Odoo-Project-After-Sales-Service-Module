...
From: "Bruce Wayne" <bruce@wayneenterprises.com>
Subject: test
Message-ID: <c0c20fdd-a38e-b296-865b-d9232bf30ce5@hashmicro.com>
...
From: {email_from}
To: {to}
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@hashmicro.com>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@hashmicro.com>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@hashmicro.com>
Content-Type: multipart/mixed;
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@hashmicro.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@hashmicro.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@hashmicro.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=hashmicro.com
Return-Path: <soup@hashmicro.com>
Received: from mail2.hashmicro.com (mail2.hashmicro.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@hashmicro.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.hashmicro.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@hashmicro.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=hashmicro.com; s=mail;
...
To: what@hashmicro.com
From: Soup <soup@hashmicro.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@hashmicro.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.hashmicro.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.hashmicro.com">http://www.hashmicro.com</a> </pre>
  </body>
</html>
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.hashmicro.com">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
