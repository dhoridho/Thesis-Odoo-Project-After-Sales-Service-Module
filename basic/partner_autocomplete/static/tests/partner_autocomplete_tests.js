odoo.define('partner_autocomplete.tests', function (require) {
    ...
    var suggestions = [{
        ...
        domain: "hashmicro.com.",
        logo: "hashmicro.com/logo.png",
        vat: "BE0477472701"
    }];
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "hashmicro.com/logo.png" ? "odoobase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
    ...
    QUnit.test("Partner autocomplete : Company type = Company / Name search", async function (assert) {
        ...
        var form = await createView({
            ...
            assert.strictEqual(form.$("input.o_field_widget").val(), "hashmicro.com.", "website value should have been updated to \"hashmicro.com\"");
