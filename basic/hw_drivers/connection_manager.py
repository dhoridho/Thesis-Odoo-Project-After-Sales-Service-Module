...
class ConnectionManager(Thread):
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.hashmicro.com/odoo-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.error('Could not reach iot-proxy.hashmicro.com')
