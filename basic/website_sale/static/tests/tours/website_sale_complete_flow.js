odoo.define('website_sale_tour.tour', function (require) {
    ...
    },
    {
        ...
        run: function () {
            ...
            $('input[name="email"]').val('abc@hashmicro.com');
    ...
    },
    {
        ...
        trigger: '.oe_login_form',
        run: function () {
            $('.oe_login_form input[name="login"]').val("abc@hashmicro.com");
    ...
    },
    {
        ...
        trigger: '#top_menu li.dropdown:visible a:contains("Administrator")',
    },
    {
        content: "Logout",
        trigger: '#o_logout:contains("Logout")',
