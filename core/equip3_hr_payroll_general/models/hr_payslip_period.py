...
class Equip3HrPayslipPeriod(models.Model):
    ...
    tax_calculation_method = fields.Selection([('monthly', 'Monthly'), ('average', 'Average')], string="Tax Calculation Method", 
                                              required=False, default=lambda self: self.env["ir.config_parameter"].sudo().get_param('equip3_hr_payroll_extend_id.tax_calculation_method'))
    tax_calculation_schema = fields.Selection([('pph21_ter', 'PPH21 TER'), ('pph21', 'PPH21')], string="Tax Calculation Schema", 
                                              required=False, default=lambda self: self.env["ir.config_parameter"].sudo().get_param('equip3_hr_payroll_extend_id.tax_calculation_schema'))
