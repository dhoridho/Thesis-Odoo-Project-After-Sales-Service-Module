odoo.define('equip3_agri_reports.budget_analysis_report', function (require) {
    'use strict';
    ...
    var BudgetAnalysisReport = AbstractAction.extend({
        ...
        printPdf: function(e) {
            e.preventDefault();
            return this.do_action('equip3_agri_reports.action_print_agriculture_budget_analysis_report', {
                additional_context: {
