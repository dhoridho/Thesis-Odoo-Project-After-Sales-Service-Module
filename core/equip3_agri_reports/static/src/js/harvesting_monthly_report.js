odoo.define('equip3_agri_reports.harvesting_monthly_report', function (require) {
    'use strict';
    ...
    var HarvestingMonthlyReport = AbstractAction.extend({
        ...
        printPdf: function(e) {
            e.preventDefault();
            return this.do_action('equip3_agri_reports.action_print_agriculture_harvesting_monthly_report', {
                additional_context: {
