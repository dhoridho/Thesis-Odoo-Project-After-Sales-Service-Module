        ...
        ksChartColors: function(palette, ksMyChart, ksChartType, ksChartFamily, stack, semi_circle, ks_show_data_value, chart_data, item) {
            ...
            switch (palette) {
                case 'cool':
                    ...
                    var color_set = ["#EB5757", "#5DB461", "#2780EA", "#302DC4", "#F3994B"]
                    break;
                case 'warm':
                    gradient = {
                        0: [249, 65, 68, 1],
                    ...
                    var color_set = ["#F94144", "#F8961E", "#90BE6D", "#F9C74F", "#F3722C"]
                    break;
                case 'neon':
                    gradient = {
                        0: [65, 86, 223, 1],
                    ...
                    var color_set = ["#4156DF", "#CC33CC", "#41DFD5"]
                    break;
                ...
                case 'default':
                    ...
                    var color_set = ["#165DFF", "#50CD89", "#FFC107", "#2780EA"]
            }
