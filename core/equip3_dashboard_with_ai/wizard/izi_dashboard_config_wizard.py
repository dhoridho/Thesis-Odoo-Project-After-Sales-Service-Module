...
class IZIDashboardConfigWizard(models.TransientModel):
    _inherit = 'izi.dashboard.config.wizard'
            ...
            for dt in data:
                try:
                    ...
                    if dt['method'] == 'model':
                        ...
                        if not table:
                            raise UserError(_('Table %s Not Found') % table_name.replace("Odoo", "Hashmicro") )
                        if not table.model_id:
                            raise UserError(_('Table %s Has No Model') % table_name.replace("Odoo", "Hashmicro"))
                    ...
                    if not source:
                        raise UserError(_('Source %s Not Found') % source_name.replace("Odoo", "Hashmicro"))
                    ...
                    if not visual_type:
                        raise UserError(_('Visual Type %s Not Found') % visual_type_name.replace("Odoo", "Hashmicro"))
                    ...
                    for metric in dt.get('metrics'):
                        ...
                        if not field:
                            continue
                            raise UserError(_('Field %s Not Found') % field_name.replace("Odoo", "Hashmicro"))
                    ...
                    if dimensions_values:
                        ...
                        raise UserError(_('Visual Type %s Must Have At Least One Dimension') % visual_type.name.replace("Odoo", "Hashmicro"))
