odoo.define('stock_3dview.ThreeDModel', function (require) {
"use strict";
    ...
    var ThreeDModel = AbstractModel.extend({
        ...
        _loadWarehouses: function (params) {
            return ajax.jsonRpc("/3dview/get_warehouses", 'call', {
                'domain': []
            }).then(function (data) {
        ...
        _loadAllLocations: function (params) {
            return ajax.jsonRpc("/3dview/get_locations/all", 'call', {
                'domain': [
                    ['usage', '=', 'internal']
                ]
            }).then(function (data) {
        ...
        _loadLegend: function (params) {
            ...
            return ajax.jsonRpc("/3dview/get_legend/" + request_type, 'call', {
                'domain': []
            }).then(function (data) {
        ...
        _loadSelectedLocations: function (params) {
            let request_type = modelData.customdata_request_type || 'tagged';
            return ajax.jsonRpc("/3dview/get_locations/" + request_type, 'call', {
