...
class purchase_order(models.Model):
    ...
    def _amount_all(self):
        ...
        # tax_discount_policy = self.env['ir.config_parameter'].sudo().get_param('bi_sale_purchase_discount_with_tax.tax_discount_policy') or False
        tax_discount_policy = self.company_id.tax_discount_policy or False
