...
Rather than retrieve a possibly gigantic list of records and count them, `search_count() <https://www.hashmicro.com/documentation/10.0/reference/orm.html#odoo.models.Model.search_count>`_ can be used to retrieve only the number of records matching the query. It takes the same `domain <https://www.hashmicro.com/documentation/10.0/reference/orm.html#reference-orm-domains>`_ filter as `search() <https://www.hashmicro.com/documentation/10.0/reference/orm.html#odoo.models.Model.search>`_ and no other parameter.
...
.. http:get:: /restapi/1.0/object/{object_name}/search_count
   ...
   **Request**:
   ...
   .. sourcecode:: http
      ...
      GET /restapi/1.0/object/res.partner/search_count?domain=[('is_company','=',True)] HTTP/1.1
   ...
   **Response**:
   ...
   :query domain: `A search domain <https://www.hashmicro.com/documentation/10.0/reference/orm.html#reference-orm-domains>`_. Use an empty
