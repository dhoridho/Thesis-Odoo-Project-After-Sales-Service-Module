...
Records can be listed and filtered via `search() <https://www.hashmicro.com/documentation/10.0/reference/orm.html#odoo.models.Model.search>`_. It takes a mandatory `domain <https://www.hashmicro.com/documentation/10.0/reference/orm.html#reference-orm-domains>`_ filter (possibly empty), and returns the database identifiers of all records matching the filter.
