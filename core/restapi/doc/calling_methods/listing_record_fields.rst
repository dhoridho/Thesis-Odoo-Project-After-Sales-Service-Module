...
`fields_get() <https://www.hashmicro.com/documentation/10.0/reference/orm.html#odoo.models.Model.fields_get>`_ can be used to inspect a model's fields and check which ones seem to be of interest.
