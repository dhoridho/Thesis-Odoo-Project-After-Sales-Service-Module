...
Record can be deleted using `unlink() <https://www.hashmicro.com/documentation/10.0/reference/orm.html#odoo.models.Model.unlink>`_, it takes a record id to delete.
...
Records can be deleted using `unlink() <https://www.hashmicro.com/documentation/10.0/reference/orm.html#odoo.models.Model.unlink>`_, it takes a list of records to delete.
