odoo.define('equip3_construction_hr_operation.progress_timer.js', function (require) {"use strict";
    ...
    var TimeCounter = fields.FieldFloatTimeHMS.extend({
        ...
        init: function () {
            ...
            this.duration = this.record.data.work_hour_duration;
        },
        ...
        _renderReadonly: function () {
            if (this.record.data.is_live && !this.record.data.is_pause) {
    ...
    field_registry.add('progress_time_counter', TimeCounter);
    fieldUtils.format.progress_time_counter = fieldUtils.format.float_time_hms;
});