...
class InProgressConfirmWizard(models.TransientModel):
    _inherit = "in.progress.confirm.const"

    # To update employee masterdata
    def confirm(self):
        res = super(InProgressConfirmWizard, self).confirm()
