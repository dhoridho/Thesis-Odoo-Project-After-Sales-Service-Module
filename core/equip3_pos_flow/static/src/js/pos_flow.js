odoo.define('equip3_pos_flow.pos_flow', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var pos_flow = AbstractAction.extend({
        contentTemplate: "pos_flow_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('pos_flow_tag', pos_flow);
    return pos_flow;
});