{
    ...
    'data': [
        ...
        'reports/moving_average.xml',
        'views/stock_scrap_request_view.xml',
        'reports/stock_scrap_request_report.xml',
        'reports/product_packaging.xml',
        'reports/picking_barcode_templates.xml'
    ...
    'qweb': [
        ...
        'static/src/xml/moving_average_report.xml'
    ],
    'demo': [],
    'installable': True,
    'application': True,
