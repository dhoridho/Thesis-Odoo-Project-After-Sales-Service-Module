...
{
    'name': 'POS Consolidated Product Sales by Month Report (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'POS Consolidated Product Sales by Month Report (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
POS Consolidated Product Sales by Month Report.
====================================
POS Consolidated Product Sales by Month in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/pos_consolidated_product_sales_by_month.xml',
    ],
    'qweb': [
    ],
    'demo': [],
