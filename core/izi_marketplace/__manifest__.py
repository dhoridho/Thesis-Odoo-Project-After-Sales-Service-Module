...
# noinspection PyUnresolvedReferences,SpellCheckingInspection
{
    ...
    "data": [
        ...
        'views/common/mp_wallet_statement_label.xml',
        'views/common/stock_picking.xml',
        'views/common/account_bank_statement.xml',
        'views/common/mp_promotion_program.xml',
        'views/common/mp_return.xml',
        'views/common/mp_order_time.xml',
        'views/common/res_partner.xml',
        'views/common/mp_log_error.xml',
        'views/common/account_bank_statement_line.xml',
        'views/common/mp_statement_line.xml',
        'views/common/mp_stock.xml',

        # wizard
        'views/wizard/wiz_mp_order.xml',
        'views/wizard/wiz_mp_order_wallet.xml',
        'views/wizard/wiz_mp_product.xml',
        'views/wizard/wiz_mp_order_return.xml',
        'views/wizard/wiz_mp_webhook_order.xml',
        'views/wizard/wiz_mp_promotion.xml',
        'views/wizard/product_template_create_variants.xml',
        'views/wizard/product_template_image_wizard.xml',
        # report paperformat
