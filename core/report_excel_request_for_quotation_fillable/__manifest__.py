...
{
    'name': 'Request for Quotation (Fillable) (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Request for Quotation (Fillable) (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
...
====================================
Request for Quotation (Fillable) in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/request_for_quotation_fillable_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
