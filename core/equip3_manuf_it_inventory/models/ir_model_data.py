...
class IrModelData(models.Model):
    ...
    @api.model
    def action_update_res_bank(self):
        return self._cr.execute("UPDATE ir_model_data SET noupdate = false WHERE module = 'base' AND name LIKE 'bank_%'")

    @api.model
    def action_noupdate_res_bank(self):
        return self._cr.execute("UPDATE ir_model_data SET noupdate = true WHERE module = 'base' AND name LIKE 'bank_%'")
