...
class ItTPBC262DocumentReport(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.tpbc262.document.report'
    _description = 'Document TPB BC-2.6.2 Report'
    _auto = False
    ...
    def get_report_name(self):
        return _('Document TPB BC-262 Report')
    ...
    def get_default_action(self, xml_id):
        action = super(ItTPBC262DocumentReport, self).get_default_action(xml_id)
