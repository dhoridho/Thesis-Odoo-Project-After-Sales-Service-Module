...
class ItTPBC25DocumentReport(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.tpbc25.document.report'
    _description = 'Document TPB BC-2.5 Report'
    _auto = False
    ...
    def get_report_name(self):
        return _('Document TPB BC-25 Report')
    ...
    def get_default_action(self, xml_id):
        action = super(ItTPBC25DocumentReport, self).get_default_action(xml_id)
