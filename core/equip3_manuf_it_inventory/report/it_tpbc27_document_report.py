...
class ItTPBC27DocumentReport(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.tpbc27.document.report'
    _description = 'Document TPB BC-2.7 Report'
    _auto = False
    ...
    def get_report_name(self):
        return _('Document TPB BC-27 Report')
    ...
    def get_default_action(self, xml_id):
        action = super(ItTPBC27DocumentReport, self).get_default_action(xml_id)
