...
class ItTPBC23DocumentReport(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.tpbc23.document.report'
    _description = 'Document TPB BC-2.3 Report'
    _auto = False
    ...
    def get_report_name(self):
        return _('Document TPB BC-23 Report')
    ...
    def get_default_action(self, xml_id):
        action = super(ItTPBC23DocumentReport, self).get_default_action(xml_id)
