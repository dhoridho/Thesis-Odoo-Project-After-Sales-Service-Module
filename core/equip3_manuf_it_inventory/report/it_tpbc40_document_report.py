...
class ItTPBC40DocumentReport(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.tpbc40.document.report'
    _description = 'Document TPB BC-4.0 Report'
    _auto = False
    ...
    def get_report_name(self):
        return _('Document TPB BC-40 Report')
    ...
    def get_default_action(self, xml_id):
        action = super(ItTPBC40DocumentReport, self).get_default_action(xml_id)
