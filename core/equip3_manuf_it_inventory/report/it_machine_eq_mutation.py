...
class ItMachineEqMutation(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.machine.eq.mutation'
    _description = 'Mutation of Machine and Equipment'
    _auto = False
    ...
    def _query(self):
        ...
        WHERE
            sw.is_it_inventory_warehouse = True AND pt.type = 'asset'
        GROUP BY
            sm.product_id
        ORDER BY
            sm.product_id
    ...
    def get_report_name(self):
        return _('Mutation of Machine and Equipment')
