...
class ItTPBC41DocumentReport(models.Model):
    _inherit = 'it.inventory.list.report'
    _name = 'it.tpbc41.document.report'
    _description = 'Document TPB BC-4.1 Report'
    _auto = False
    ...
    def get_report_name(self):
        return _('Document TPB BC-41 Report')
    ...
    def get_default_action(self, xml_id):
        action = super(ItTPBC41DocumentReport, self).get_default_action(xml_id)
