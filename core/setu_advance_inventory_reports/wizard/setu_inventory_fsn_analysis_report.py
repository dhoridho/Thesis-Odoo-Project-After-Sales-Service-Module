...
class SetuInventoryFSNAnalysisReport(models.TransientModel):
    ...
    def download_report(self):
        ...
        return {
            ...
            'url': '/web/binary/download_document?model=setu.inventory.fsn.analysis.report&field=stock_file_data&id=%s&filename=%s'%(self.id, file_name),
            'target': 'self',
        }
...
class SetuInventoryFSNAnalysisBIReport(models.TransientModel):
    ...
    _description = 'Setu Inventory FSN Analysis BI Report'
