...
{
    'name': 'Quotation with Product Images (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Quotation with Product Images (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
...
====================================
Quotation with Product Images in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/quotation_with_product_images_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
