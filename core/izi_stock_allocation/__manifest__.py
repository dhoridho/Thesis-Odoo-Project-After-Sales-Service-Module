...
{
    "name": """IZI Stock Allocation""",
    "summary": """IZI Stock Allocation New""",
    "category": "Warehouse",
    "version": "1.1.1",
    ...
    "data": [
        ...
        # view
        'views/common/stock_allocation_balance.xml',
        'views/common/stock_allocation_move.xml',
        'views/common/stock_allocation_balance_current.xml',
        'views/common/sale_channel.xml',
