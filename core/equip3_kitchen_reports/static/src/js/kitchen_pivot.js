odoo.define('equip3_kitchen_reports.KitchenPivotView', function (require) {
"use strict";
...
var kitchenPivotView = PivotView.extend({
...
viewRegistry.add('kitchen_pivot', kitchenPivotView);
