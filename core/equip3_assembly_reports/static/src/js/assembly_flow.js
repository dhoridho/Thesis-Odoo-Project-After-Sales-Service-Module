odoo.define('equip3_assembly_reports.assembly_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var assembly_flow = AbstractAction.extend({
            contentTemplate: "assembly_flow_wizard_action_one",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('assembly_flow_tag', assembly_flow);
