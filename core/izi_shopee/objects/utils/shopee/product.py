...
class ShopeeProduct(ShopeeAPI):
    ...
    def get_product_info(self, pd_data=None, product_id=None):
        ...
        if pd_data:
            ...
            item_id_list.extend(product_id)
    ...
    def get_product_list(self, limit=0, per_page=50):
        ...
        if unlimited:
            ...
            while unlimited:
                ...
                if sp_data_list and 'item' in sp_data_list:
                    n = max(1, 25)
    ...
    def set_product_price(self, item_id=None, price=0):
        payload = {
            'item_id': item_id,
            'price_list': [{
                'model_id': 0,
        ...
        prepared_request = self.build_request('set_product_price',
                                              self.sp_account.partner_id,
                                              self.sp_account.partner_key,
                                              self.sp_account.shop_id,
                                              self.sp_account.host,
        ...
        sp_data_list = self.process_response('set_product_price', self.request(**prepared_request))
        return sp_data_list

    def set_product_stock(self, item_id=None, stock=0):
        payload = {
            'item_id': item_id,
            'stock_list': [{
                'model_id': 0,
        ...
        prepared_request = self.build_request('set_product_stock',
                                              self.sp_account.partner_id,
                                              self.sp_account.partner_key,
                                              self.sp_account.shop_id,
                                              self.sp_account.host,
        ...
        sp_data_list = self.process_response('set_product_stock', self.request(**prepared_request))
        return sp_data_list

    def set_product_detail(self, item_id=None, item_data=None):
        payload = {
            'item_id': item_id
        }
        if item_data:
            payload.update(item_data.get('json'))
        prepared_request = self.build_request('set_product_detail',
                                              self.sp_account.partner_id,
                                              self.sp_account.partner_key,
                                              self.sp_account.shop_id,
                                              self.sp_account.host,
        ...
        sp_data_list = self.process_response('set_product_detail', self.request(**prepared_request))
        return sp_data_list
