...
{
    'name': 'Customer Invoice with Payment (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Customer Invoice with Payment (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
Customer Invoice with Payment (XLSX)
====================================
Customer Invoice with Payment in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/customer_invoice_with_payment_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
