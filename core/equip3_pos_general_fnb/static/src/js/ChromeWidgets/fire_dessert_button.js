odoo.define('equip3_pos_general_fnb.fire_dessert_button', function (require) {
    'use strict';
    ...
    class  FireDessertButton extends PosComponent {
        constructor() {
            super(...arguments);
        }
        async click() {
            ...
            if(existing_receipt){
                ...
                let categ_ids = this.env.pos.config.fire_dessert;
                ...
                this.env.pos.alert_message({
                    ...
                    body: this.env._t('Dessert has been sent to the KOT')
                });
    ...
    FireDessertButton.template = 'FireDessertButton';
    Registries.Component.add(FireDessertButton);
    return FireDessertButton;
});