...
{
    'name': 'Quotation Grouping by Category (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Quotation Grouping by Category (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
...
====================================
Quotation Grouping by Category in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    ...
    'data': [
        'data/quotation_grouping_by_category_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
