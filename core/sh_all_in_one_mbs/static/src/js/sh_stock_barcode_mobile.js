$(document).ready(function () {
    ...
    function decodeOnce(codeReader, selectedDeviceId, $input) {
        codeReader
    ...
    function decodeContinuously(codeReader, selectedDeviceId, $input) {
    ...
    codeReader
        ...
        .then(function (result) {
            ...
            $(document).on("click", "#js_id_sh_stock_barcode_mobile_start_btn", function (event) {
                var $target = $(event.currentTarget).parent().find('input[name="sh_stock_barcode_mobile"]');
                //EMPTY INPUT
                $('input[name="sh_stock_barcode_mobile"]').val("");
                $('input[name="sh_stock_barcode_mobile"]').change();
                ...
                if ($('span[name="sh_stock_bm_is_cont_scan"]').text() == "True") {
                    decodeContinuously(codeReader, selectedDeviceId, $target);
                } else {
                    decodeOnce(codeReader, selectedDeviceId, $target);
                }
            });
