odoo.define('equip3_manuf_cutting.cutting_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var cutting_flow = AbstractAction.extend({
            contentTemplate: "cutting_flow_wizard_action_one",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('cutting_flow_tag', cutting_flow);
        return cutting_flow;
    });