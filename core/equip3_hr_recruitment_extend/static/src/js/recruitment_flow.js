odoo.define('equip3_hr_recruitment_extend.recruitment_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var recruitment_flow = AbstractAction.extend({
            contentTemplate: "recruitment_configuration_action",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('recruitment_flow_tag', recruitment_flow);
        return recruitment_flow;
    });