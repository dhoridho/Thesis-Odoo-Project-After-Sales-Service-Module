odoo.define('web.searchUtils', function (require) {
    ...
    const FIELD_OPERATORS = {
        ...
        number: [
            { symbol: "=", description: _lt("is equal") },
            // { symbol: "!=", description: _lt("is not equal to") },
            { symbol: "<", description: _lt("is less than") },
            { symbol: ">", description: _lt("is more than") },
            // { symbol: ">=", description: _lt("greater than or equal to") },
            // { symbol: "<=", description: _lt("less than or equal to") },
            { symbol: "!=", description: _lt("is set"), value: 0 },
            { symbol: "=", description: _lt("is not set"), value: 0 },
        ],
        selection: [
            { symbol: "=", description: _lt("is") },
