...
var GraphController = AbstractController.extend({
    ...
    renderButtons: function ($node) {
        ...
        if(this.title=='hr.quadrant.analysis.report'){
            
            this.$buttons.find('.fa-bar-chart-o').css("left", "-90px");
            this.$buttons.find('.fa-area-chart').hide();
            this.$buttons.find('.fa-pie-chart').hide();
            this.$buttons.find('.fa-sort-amount-desc').hide();
            this.$buttons.find('.fa-sort-amount-asc').hide();
            this.$buttons.find('.fa-database').hide();
        }
