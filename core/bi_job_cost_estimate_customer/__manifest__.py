...

{
    ...
    'version': '1.1.2',
    'category': 'Project',
    'summary': 'Apps helps to calculate Job Estimation for Materials Estimation for labour Estimation for Overheads Job Estimation Materials cost job Estimation labour cost job Estimation Overhead Estimation Materials cost Estimation labour cost Estimation Overheads cost',
    'description': """
