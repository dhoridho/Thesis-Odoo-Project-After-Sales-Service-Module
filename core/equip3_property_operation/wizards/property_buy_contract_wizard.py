...
class PropertyBuy(models.TransientModel):
    ...
    contract_id = fields.Many2one('agreement',string="Contract Template", required=True, domain="[('is_template','=',True), ('invoice_type','=','non_recurring'), ('agreement_type_id.name','=','Agreement')]")
        ...
        agr = agreement.write(
            {
                ...
                "line_ids": [(0, 0, {
                    ...
                    "qty": 1,
                    "unit_price": self.property_price,
                })],
            }
        )
        if agr:
