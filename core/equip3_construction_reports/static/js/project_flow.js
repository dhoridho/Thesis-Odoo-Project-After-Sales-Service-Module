odoo.define('equip3_construction_reports.const_sale_configuration_flow', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var const_sale_configuration_flow = AbstractAction.extend({
        contentTemplate: "construction_sale_flow_configuration_action",
        hasControlPanel: !1,
        events: {
            "click button.btn-action": "_onOpen",
    ...
    core.action_registry.add('construction_sale_configuration_flow_tag', const_sale_configuration_flow);
    return const_sale_configuration_flow;
});