odoo.define('equip3_pos_payment_edc.PaymentLineEdc', function (require) {
    'use strict';
    ...
    class PaymentLineEdc extends PosComponent {
        constructor() {
            super(...arguments);
        }
            ...
            return new Promise(function (resolve, reject) {
                ...
                timer = setInterval(function () {
                    ...
                    let vals = {
                        ...
                        'fields': ['id','payment_state','resp_code','invoice_number','order_number','approval_code'],
                        'limit': 1,
    ...
    PaymentLineEdc.template = 'PaymentLineEdc';
    Registries.Component.add(PaymentLineEdc);
    return PaymentLineEdc;
});