...
class InvoicePaymentReportXLS(models.Model):
    _name = 'invoice.payment.report.xls'
    ...
    def download_report(self):
        ...
        return{
            ...
            'url': 'web/content/?model=invoice.payment.report.xls&field=excel_file&download=true&id=%s&filename=%s' % (self.id, self.file_name),
            'target': 'new',
        }
...
class SHPaymentReportWizard(models.TransientModel):
    ...
    _description = "payment report wizard model"
    ...
    def print_xls_report(self):
        ...
        export_id = self.env['invoice.payment.report.xls'].sudo().create({
        ...
        return{
            ...
            'res_id': export_id.id,
            'res_model': 'invoice.payment.report.xls',
            'view_mode': 'form',
            'target': 'new',
        }
