                ...
                for key in order_dic_by_orders.keys():
                    ...
                    for rec in order_dic_by_orders[key]:
                        ...
                        worksheet.write(row, 3, str(rec.get(
                            'sale_currency_id'))+str("{:.2f}".format(rec.get('sale_amount'))), center)
                        worksheet.write(row, 4, str(rec.get(
                            'sale_currency_id')) + str("{:.2f}".format(rec.get('paid_amount'))), center)
                        worksheet.write(row, 5, str(rec.get(
                            'sale_currency_id')) + str("{:.2f}".format(rec.get('balance_amount'))), center)
