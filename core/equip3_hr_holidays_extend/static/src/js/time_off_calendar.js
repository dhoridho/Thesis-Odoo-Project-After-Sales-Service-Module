    ...
    var TimeOffCalendarPopover = CalendarPopover.extend({
        ...
        init: function (parent, eventInfo) {
            ...
            if (this.modelName === "hr.leave.report.calendar") {
                ...
                const leave_type_name = this.event.extendedProps.record.leave_type[1]
                this.display_name = _.str.sprintf(_t("Duration : %s"), duration);
                this.leave_type = leave_type_name
            } else {
