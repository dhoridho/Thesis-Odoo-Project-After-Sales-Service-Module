odoo.define('equip3_hr_elearning_extend.elearning_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var elearning_flow = AbstractAction.extend({
            contentTemplate: "elearning_configuration_action",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('elearning_flow_tag', elearning_flow);
        return elearning_flow;
    });