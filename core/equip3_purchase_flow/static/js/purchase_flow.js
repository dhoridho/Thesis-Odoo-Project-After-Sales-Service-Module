odoo.define('equip3_purchase_flow.purchase_configuration_flow', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var purchase_configuration_flow = AbstractAction.extend({
        contentTemplate: "purchase_flow_configuration_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('purchase_configuration_flow_tag', purchase_configuration_flow);
    return {
        purchase_configuration_flow: purchase_configuration_flow,
    };
});