odoo.define('equip3_purchase_flow.service_configuration_flow', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var service_configuration_flow = AbstractAction.extend({
        contentTemplate: "service_flow_configuration_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('service_configuration_flow_tag', service_configuration_flow);
    return {
        service_configuration_flow: service_configuration_flow,
    };
});