...
class ReportStudentTimetable(models.AbstractModel):
    _name = 'report.equip3_school_report.student_timetable'
    _description = "Student Timetable details"

    def _get_student_timetable(self, timetable_id):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        timetable_report = self.env['ir.actions.report']._get_report_from_name(
            'equip3_school_report.student_timetable')
        ...
        return {
            ...
            'data': data,
            'get_timetable': self._get_student_timetable
        }
