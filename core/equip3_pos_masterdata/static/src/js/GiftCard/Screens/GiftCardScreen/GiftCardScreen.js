odoo.define('equip3_pos_masterdata.GiftCardScreen', function (require) {
    'use strict';
                    ...
                    if (this.state.selectedCard.card_no) {
                        new Promise(function (resolve, reject) {
                            ...
                            rpc.query(params, {async: false}).then(function (result) {
                                ...
                                self.env.pos.chrome.showNotification(self.env._t('Warning'), self.env._t('Connection lost, Your Internet or Your Server Offline Mode'))
                                reject();
                            });
                        });
                    } else {
