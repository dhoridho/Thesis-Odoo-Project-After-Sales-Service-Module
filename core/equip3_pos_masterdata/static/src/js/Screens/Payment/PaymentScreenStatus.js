odoo.define('equip3_pos_masterdata.PaymentScreenStatus', function (require) {
    'use strict';
        ...
        class extends PaymentScreenStatus {
            ...
            get getTipTotal() {
                ...
                if (!currentOrder || !this.env.pos.config.iface_tipproduct || !currentOrder || !this.env.pos.config.tip_product_id) {
                    ...
                    if (tipTotal) {
                        return this.env.pos.format_currency(tipTotal,false,currentOrder.currency)
                    } else {
                        return null
                    }
                }
            ...
            get getDiscountTotal() {
                ...
                if (discountTotal) {
                    return this.env.pos.format_currency(discountTotal,false,currentOrder.currency)
                } else {
                    return null
                }
            }
