odoo.define('equip3_pos_masterdata.ReprintReceiptButton', function (require) {
    'use strict';
            ...
            async _onClick() {
                ...
                if (this.env.pos.epson_printer_default || (this.env.pos.config.proxy_ip && this.env.pos.config.iface_print_via_proxy)) {
                    ...
                    return this.env.pos.alert_message({
                        title: this.env._t('Warning, This feature of POS Original not Compatible with our module'),
