odoo.define('equip3_pos_masterdata.CashSession', function (require) {
    'use strict';
    ...
    class CashSession extends AbstractAwaitablePopup {
        ...
        async _initCashInOutReason() {
            let self = this;
            self.env.pos.cash_inout_products_reason = this.env.pos.config.cash_inout_reason_ids
...
//                product_id: this.env.pos.cash_inout_products_reason[0].id,
                reason: this.env.pos.cash_inout_products_reason,
