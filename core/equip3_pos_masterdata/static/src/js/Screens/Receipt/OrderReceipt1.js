odoo.define('equip3_pos_masterdata.OrderReceipt1', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class OrderReceipt1 extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    OrderReceipt1.template = 'OrderReceipt1';

    Registries.Component.add(OrderReceipt1);

    return OrderReceipt1;
});
