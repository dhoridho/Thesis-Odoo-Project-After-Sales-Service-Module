odoo.define('equip3_pos_general.ConfirmPopupPickupSO', function(require) {
    'use strict';
    ...
    class ConfirmPopupPickupSO extends AbstractAwaitablePopup {}
    ConfirmPopupPickupSO.template = 'ConfirmPopupPickupSO';
    ConfirmPopupPickupSO.defaultProps = {
        confirmText: 'Yes',
        cancelText: 'Cancel',
        title: 'Confirm ?',
        body: '',
    ...
    Registries.Component.add(ConfirmPopupPickupSO);

    return ConfirmPopupPickupSO;
});

odoo.define('equip3_pos_masterdata.SaleOrderDetail', function (require) {
    'use strict';
    ...
    class SaleOrderDetail extends PosComponent {
        constructor() {
            ...
            useListener('actionConfirmSelfPicking', () => this.actionConfirmSelfPicking());
        ...
        async actionConfirmSelfPicking() {
            await this.rpc({
                model: 'sale.order',
                method: 'action_confirm_self_picking',
