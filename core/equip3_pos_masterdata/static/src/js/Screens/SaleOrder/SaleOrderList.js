odoo.define('equip3_pos_masterdata.SaleOrderList', function (require) {
    'use strict';
    ...
    class SaleOrderList extends PosComponent {
        ...
        back() {
            console.log(this.state.detailIsShown,'this.state.detailIsShownthis.state.detailIsShown')
