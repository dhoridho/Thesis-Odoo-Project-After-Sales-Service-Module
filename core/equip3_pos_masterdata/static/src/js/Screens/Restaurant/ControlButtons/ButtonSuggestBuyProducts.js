odoo.define('equip3_pos_masterdata.ButtonSuggestBuyProducts', function (require) {
    'use strict';
            ...
            if (order) {
                ...
                if (!selectedLine) {
                    return this.showPopup('ErrorPopup', {
                        ...
                        body: this.env._t('There is not Product selected in the Cart!')
                    })
                }
                order.suggestItems(selectedLine.product);
            }
        }
    }
