odoo.define('equip3_pos_masterdata.PopUpCreateShippingOrder', function (require) {
    'use strict';
    ...
    class PopUpCreateShippingOrder extends AbstractAwaitablePopup {
        ...
        verifyChanges() {
            ...
            if (!changes.delivery_address || changes.delivery_address == ''){
                changes.delivery_address = $('.PopUpCreateShippingOrder input[name="delivery_address"]').val()
            }
            if (!changes.delivery_phone || changes.delivery_phone == ''){
                changes.delivery_phone = $('.PopUpCreateShippingOrder input[name="delivery_phone"]').val()
            }
