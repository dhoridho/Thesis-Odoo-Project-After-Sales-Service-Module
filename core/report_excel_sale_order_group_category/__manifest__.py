...
{
    'name': 'Sale Order Grouping by Category (XLSX)',
    'version': '1.0.0',
    'category': 'Extra Tools',
    'summary': 'Sale Order Grouping by Category (XLSX) (XLSX)',     
    'price': 0.00,
    'currency': 'EUR',
    "license": "OPL-1",     
    'description': """
Sale Order Grouping by Category (XLSX)
====================================
Sale Order Grouping by Category (XLSX) in MS Excel format (XLSX)
...
#     'live_test_url': "http://68.183.4.193:8069",
    'depends': ['account', 'sale', 'delivery', 'product'],
    'images': ['static/description/banner_rep.png'],
    'data': [
        'data/sale_order_grouping_by_category_xlsx.xml',
    ],
    'qweb': [
    ],
    'demo': [],
