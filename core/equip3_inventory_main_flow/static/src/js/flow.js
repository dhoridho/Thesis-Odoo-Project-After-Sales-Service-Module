odoo.define('equip3_inventory_main_flow.flow_configuration_action', function (require){
"use strict";
    ...
    var flow_configuration = AbstractAction.extend({
        contentTemplate: "flow_configuration_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('flow_menu_tag', flow_configuration);
