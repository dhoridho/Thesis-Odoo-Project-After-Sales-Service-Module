odoo.define('equip3_manuf_reports.MovingProductionCostReport', function(require){
    "use strict";
    ...
    var ReportFormController = FormController.extend({
        ...
        start: function(){
            ...
            return this._super.apply(this, arguments).then(function(){
                self.$el.addClass('o_moving_production_report');
            });
        },
        ...
        renderButtons: function ($node) {
            this._super.apply(this, arguments);
            if (this.$buttons){
                this.$buttons.append(Qweb.render('MovingProductionCostReportFilter', {filters: this.filters}));
            }
        },
    ...
    var ReportFormRenderer = FormRenderer.extend({
        ...
        _renderBomTable: function(report_data){
            var $content = Qweb.render('MovingProductionCostReport', {
                data: report_data,
        ...
        _renderBomChart: function(report_data){
            ...
            var data = {
                labels: _.map(report_data.productions, o => [o.display_name, o.date]),
                datasets: [{
            ...
            var $legendContent = $(Qweb.render('MovingProductionCostReportLegend', {
    ...
    viewRegistry.add('moving_production_cost_report', ReportFormView);
