...
class PosKeyboardShortcuts(models.Model):
    ...
    _description = "Pos Keyboard Shortcuts"

    name = fields.Char(required=True)

    # Product Screen Shotcuts
    next_screen = fields.Char(string="Next Screen",size=3,default="N")
    customer_screen = fields.Char(string="Customer Screen",size=3,default="C")
    search_product = fields.Char(string="Search Product",size=3,default="S")
    ...
    select_qty = fields.Char(string="Select Quantity in Numpad",size=3,default="Q")
    select_discount = fields.Char(string="Select Discount in Numpad",size=3,default="D")
    select_price = fields.Char(string="Select Price in Numpad",size=3,default="P")
    create_customer = fields.Char(string="Add a Customer",size=3,default="A")
    ...
    order_invoice = fields.Char(string="Order Invoice",size=3,default="I")    
    ...
    print_receipt = fields.Char(string="Print Receipt",size=3,default="R")
    next_screen_show = fields.Char(string="Show Next Screen",default="Enter")

    #Common Shortcuts
    back_screen = fields.Char(string="Back Screen",size=3,default="B")
    ...
    select_user = fields.Char(string="Select POS User",size=3,default="U")
    refresh = fields.Char(string="Refresh Connection", size=3, default="Z")
    close_pos = fields.Char(string="Close POS Session", size=3, default="M")
