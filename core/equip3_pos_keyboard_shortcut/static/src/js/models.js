                ...
                if (product_screen){
                    ...
                    if(!is_popup){
                        ...
                        if(all_shortcuts.customer_screen && (shortcut_pressed == all_shortcuts.customer_screen.toUpperCase())){
                            ...
                            if($('.pos-button-list').length==0){
                                $('.button_open_feature').click();
                            }
                            setTimeout(() => {
                              $('.customer-facing-screen-button').click();
                            }, 1000);
                        }
                        if(all_shortcuts.create_customer && (shortcut_pressed == all_shortcuts.create_customer.toUpperCase())){
                            ...
                            setTimeout(function(){
                                $('div[search_members="1"] input').focus()
                            },500);
                    ...
                    if(!is_popup){
                        if(all_shortcuts.back_screen && (shortcut_pressed == all_shortcuts.back_screen.toUpperCase())){
                            ...
                            if($('button.back').length!=0){
                                $($('button.back')[$('button.back').length-1]).click();
                            }
                            else{
                                $('div.back').click();
                            }
                    ...
                    if(!is_popup){
                        ...
                        if(e.key.toUpperCase() == 'ENTER'){
                            ...
                            if($('div[search_members="1"] input').val() && $('.tr_child_line').length==1){
