...
class CrossoveredBudgetLines(models.Model):
    ...
    practical_amount = fields.Monetary(
        compute='_compute_practical_amount', string='Used Amount', help="Amount really earned/spent.")
    ...
    def _compute_percentage(self):
        for line in self:
            if line.theoritical_amount != 0.00:
                line.percentage = float((line.practical_budget_amount or 0.0) / line.theoritical_amount)
            else:
