...
class RentalProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        if bool(self.env['ir.config_parameter'].sudo().get_param('is_product_service_operation_delivery')):
            ...
            for procurement in procurements:
                ...
                # Add 'asset' to make asset product type create delivery or stock picking
                if (
            ...
            return super(RentalProcurementGroup, self).run(procurements, raise_user_error=raise_user_error)