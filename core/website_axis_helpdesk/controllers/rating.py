...
class WebsiteHelpdesk(http.Controller):
    ...
    def page(self, team=False, **kw):
        ...
        if user.has_group('website_axis_helpdesk.group_heldpesk_manager'):
        ...
        return request.render('website_axis_helpdesk.team_rating_page', {'page_name': 'rating', 'teams': team_values})
