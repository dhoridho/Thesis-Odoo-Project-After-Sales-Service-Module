odoo.define('equip3_asset_fms_restructure_menu_flow.asset_fms_flow_configuration_action', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var flow_configuration = AbstractAction.extend({
        contentTemplate: "asset_fms_flow_configuration_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('asset_fms_flow_menu_tag', flow_configuration);
