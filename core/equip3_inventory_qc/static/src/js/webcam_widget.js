...
*/
odoo.define('equip3_inventory_qc.webcam_widget', function(require) {
    "use strict";
    ...
    FieldBinaryImage.include({
        ...
        _render: function () {
            ...
            Webcam.set({
                ...
                force_flash: false,
                fps: 45,
                swfURL: '/equip3_inventory_qc/static/src/js/webcam.swf',
            });
            ...
            self.$el.find('.o_form_binary_file_web_cam').off().on('click', function(){
                ...
                dialog.opened().then(function() {
                    ...
                    WebCamDialog.find("#webcam_result").html('<img src="/equip3_inventory_qc/static/src/img/webcam_placeholder.png"/>');
                });
            });
        },
    });
