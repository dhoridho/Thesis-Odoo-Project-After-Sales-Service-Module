odoo.define("equip3_spreadsheet.SpreadsheetAbstractAction", function (require) {
    "use strict";

    const AbstractAction = require("web.AbstractAction");
    const SpreadsheetComponent = require("equip3_spreadsheet.SpreadsheetComponent");
    const SpreadsheetControlPanel = require("equip3_spreadsheet.ControlPanel");
    ...
    const SpreadsheetAbstractAction = AbstractAction.extend({
        ...
        contentTemplate: "equip3_spreadsheet.SpreadsheetAction",
        events: {},
        custom_events: {
