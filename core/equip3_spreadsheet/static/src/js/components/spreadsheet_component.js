odoo.define("equip3_spreadsheet.SpreadsheetComponent", function (require) {
    "use strict";

    const core = require("web.core");
    const Dialog = require("web.OwlDialog");
    const PivotDialog = require("equip3_spreadsheet.PivotDialog")
    ...
    class SpreadsheetComponent extends owl.Component {
        ...
        async _saveAsTemplate() {
            ...
            this.trigger("do-action", {
                action: "equip3_spreadsheet.save_spreadsheet_template_action",
                options: {
                    additional_context: {
    ...
    SpreadsheetComponent.template = "equip3_spreadsheet.SpreadsheetComponent";
