...
class ResCompany(models.Model):
    ...
    purchase_show_signature = fields.Boolean(
        "Enable digital sign in Purchase Orders ?")
...
class ResConfigSettings(models.TransientModel):
    ...
    purchase_show_signature = fields.Boolean(
        "Enable digital sign in Purchase Orders ?", related="company_id.purchase_show_signature", readonly=False)
...
class PurchaseOrder(models.Model):
    ...
    def button_confirm(self):
        ...
        if self.chk_sign_confirm and self.purchase_show_signature:
