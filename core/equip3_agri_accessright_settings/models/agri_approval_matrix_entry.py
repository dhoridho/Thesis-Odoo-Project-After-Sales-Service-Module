...
class AgriApprovalMatrixEntry(models.Model):
    _name = 'agri.approval.matrix.entry'
    _description = 'Agriculture Approval Matrix Entry'
    ...
    line_id = fields.Many2one(comodel_name='agri.approval.matrix.line', required=True, string='Approval Matrix Line')
    ...
    line_ids = fields.One2many(
        comodel_name='agri.approval.matrix.entry.line', 
...
class AgriApprovalMatrixEntryLine(models.Model):
    _name = 'agri.approval.matrix.entry.line'
    _description = 'Agriculture Approval Matrix Entry Line'
