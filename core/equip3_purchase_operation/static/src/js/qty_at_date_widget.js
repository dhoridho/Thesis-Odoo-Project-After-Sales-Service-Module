odoo.define('equip3_purchase_operation.QtyAtDateWidget', function (require) {
"use strict";
...
var QtyAtDateWidget = Widget.extend({
    template: 'equip3_purchase_operation.qtyAtDate',
    ...
    _getContent() {
        ...
        const $content = $(QWeb.render('equip3_purchase_operation.QtyDetailPopOver', {
            data: this.data,
        }));
