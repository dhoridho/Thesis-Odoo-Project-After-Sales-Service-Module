...
class PosPaymentWizard(models.TransientModel):
    ...
    def pos_payment_report(self):
        return self.env.ref('equip3_pos_report.action_pos_payment_report').report_action(self)
    ...
    def print_excel_report(self):
        ...
        branch_data = self.branch_id or False
        company_data = self.company_id or False
        ...
        pos_orders = self.env['pos.order'].search([('date_order','>=',self.start_dt ) , 
        ...
        return {
            ...
            'target': 'new',
            'context': {
                'form_view_ref': 'equip3_pos_report.view_pos_payment_xls',
            }
        }
...
class SaleExcelReport(models.TransientModel):
    ...
    name = fields.Char('Name', default='Report')
