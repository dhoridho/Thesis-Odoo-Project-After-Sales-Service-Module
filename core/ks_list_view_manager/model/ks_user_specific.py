...
class UserSpecific(models.Model):
    ...
    ks_is_global = fields.Boolean("Global List View")
    ...
    def check_user_exists(self, model_name, uid, ks_action_id):
        ...
        ks_is_global = False
        if self.env['ir.config_parameter'].sudo().get_param('ks_is_global', False) == 'True':
            uid = False
            ks_is_global = True
...
class KsHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        rec['ks_is_global'] = self.env['ir.config_parameter'].sudo().get_param('ks_is_global')
        self.clear_caches()
        return rec
...
class KsResConfigSettings(models.TransientModel):
    ...
    ks_o2m_serial_number = fields.Boolean(string="One2Many List Serial Number",
                                          config_parameter='ks_o2m_serial_number')
    ks_is_global = fields.Boolean("Global List View",
                                  config_parameter='ks_is_global')
