...

{
    ...
    odoo Custom product bundle Custom Product Pack hashmicro.combo product pack combo product combo bundle pack combo bundle product pack 
    hashmicro.combo product pack multiple product pack group product pack choice odoo
    ...
    hashmicro.combo product pack kit combo product combo kit bundle pack combo kit product pack kit 
    hashmicro.combo product kit multiple product kit group product kit choice odoo
