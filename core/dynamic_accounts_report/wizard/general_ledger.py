...
class GeneralView(models.TransientModel):
    ...
    def get_dynamic_xlsx_report(self, data, response ,report_data, dfr_data):
        ...
        sheet.write('E8', 'Balance', sub_heading)
        ...
        for rec_data in report_data_main:
            ...
            sheet.write(row + 1, col + 2, rec_data['debit'], txt)
            sheet.write(row + 1, col + 3, rec_data['credit'], txt)
            sheet.write(row + 1, col + 4, rec_data['balance'], txt)
