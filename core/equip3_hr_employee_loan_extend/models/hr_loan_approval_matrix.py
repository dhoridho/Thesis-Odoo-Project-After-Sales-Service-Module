...
class LoanApprovalMatrix(models.Model):
    ...
    applicable_to = fields.Selection(
        [('loan_request', 'Loan Request'), ('loan_installment', 'Loan Installment')],
        default='loan_request', string="Applicable To")
    ...
    def search_read(self, domain=None, fields=None, offset=0, limit=None, order=None):
        ...
        result = super(LoanApprovalMatrix, self).search_read(domain=domain, fields=fields, offset=offset, limit=limit, order=order)
        return result
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        return super(LoanApprovalMatrix, self).read_group(domain, fields, groupby, offset=offset, limit=limit, orderby=orderby, lazy=lazy)
