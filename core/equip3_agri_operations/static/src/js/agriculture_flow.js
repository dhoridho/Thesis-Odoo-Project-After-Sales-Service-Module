odoo.define('equip3_agri_operations.agriculture_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var agriculture_flow = AbstractAction.extend({
            contentTemplate: "agriculture_flow_wizard_action_one",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('agriculture_flow_tag', agriculture_flow);
        return agriculture_flow;
    });