odoo.define('equip3_agri_operations.harvesting_monthly_report', function (require) {
    'use strict';
    ...
    var HarvestingMonthlyReport = AbstractAction.extend({
        template: 'HarvestingMonthlyReportTemplate',
        ...
        init: function(parent, action) {
            ...
            this.searchModelConfig.modelName = 'agriculture.harvesting.monthly.report'
        },
        ...
        start: async function() {
            ...
            var self = this;
            this._rpc({
                model: 'agriculture.harvesting.monthly.report',
                method: 'create',
        ...
        loadData: function (initial_render) {
            ...
            return this._rpc({
                ...
                if (initial_render) {
                    self.$('.o_agri_report_header').html(QWeb.render('HarvestingMonthlyReportHeader', {
        ...
        _renderContent: function(content){
            this.$('.o_agri_report_content').html(QWeb.render('HarvestingMonthlyReportTable', {
        ...
        printPdf: function(e) {
            e.preventDefault();
            return this.do_action('equip3_agri_operations.action_print_agriculture_harvesting_monthly_report', {
                additional_context: {
                    'active_id': this.wizard_id,
                    'active_ids': [this.wizard_id],
                    'active_model': 'agriculture.harvesting.monthly.report'
                }
            });
        },
    ...
    core.action_registry.add("agriculture_harvesting_monthly_report", HarvestingMonthlyReport);
    return HarvestingMonthlyReport;
});