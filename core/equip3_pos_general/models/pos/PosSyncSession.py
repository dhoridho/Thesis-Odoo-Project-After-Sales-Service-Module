...
class PosSyncSessionOrder(models.Model):
    _inherit = 'pos.sync.session.order'
...
class PosSyncSessionLog(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', string='Branch', related="send_to_session_id.pos_branch_id")
    company_id = fields.Many2one('res.company', string='Company', related="send_to_session_id.company_id")