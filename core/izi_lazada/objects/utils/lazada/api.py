...
from .tools import pagination_datetime_range
...
class LazadaAPI(object):
    ...
    def __init__(self, lz_account, host="all", api_version="v2", **kwargs):
        self.lz_account = lz_account
        self.api_version = api_version
        self.endpoints = LazadaEndpoint(lz_account, host=host, api_version=api_version)
        self.lazop_client = LazopClient(**{
            'server_url': self.endpoints.HOSTS[host],
            'app_key': self.lz_account.app_key,
            'app_secret': self.lz_account.app_secret
        })
