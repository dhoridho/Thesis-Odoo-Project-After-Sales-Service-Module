...
class LazadaDownloadPDF(http.Controller):

    @http.route('/web/binary/lazada/download_pdf/', type='http', auth="public", website=True)
    ...
    @http.route('/web/binary/lazada/open_pdf/', type='http', auth="public", website=True)
