...

{
    ...
    9. Customize "My hashmicro.com account" button
    ...
    20. Show quick upgrade in app dashboard, click to show module info not go to hashmicro.com
    ...
    9. 在用户菜单中自定义"My hashmicro.com account"
    ...
    20. 在应用面板显示快速升级按键，点击时不会导航至 hashmicro.com
    21. 清除并重置会计科目表
