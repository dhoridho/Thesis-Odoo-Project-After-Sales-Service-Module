...
class ShopifyProductProductEpt(models.Model):
    ...
    def import_shopify_stock(self, instance):
        ...
        self.search_and_cancel_inventory_adjustment()
        ...
        if templates:
            ...
            for location_id in location_ids:
                ...
                stock_inventory_array = self.prepare_val_for_stock_inventory(location_id, inventory_levels, instance)
    ...
    def search_and_cancel_inventory_adjustment(self):
        """ This method is used to search existing inventory in odoo and cancel it if found.
            @param : self
            @author: Haresh Mori @Emipro Technologies Pvt. Ltd on date 21 October 2020 .
            Task_id: 167537
        """
    ...
    def prepare_val_for_stock_inventory(self, location_id, inventory_levels, instance):
