...
class ShopifyInstanceEpt(models.Model):
    ...
    def _default_refund_adjustment_product(self):
        """
        This method is used to set the gift card product in an instance.
        @author: Meera Sidapara on Date 20-Dec-2021.
        """
    ...
    def set_shopify_import_after_date(self):
        ...
        for instance in instances:
            ...
            service_product_id = self.custom_service_product_id
            storable_product_id = self.custom_storable_product_id
            if service_product_id and storable_product_id:
