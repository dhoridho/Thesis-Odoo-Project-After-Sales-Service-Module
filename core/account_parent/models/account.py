...
class AccountAccount(models.Model):
	...
	def compute_values(self):
		...
		extra_domain = self._context.get('extra_domain', [])
		...
		for account in self:
			...
			tables, where_clause, where_params = self.env['account.move.line'].with_context(context)._query_get(domain=extra_domain)
