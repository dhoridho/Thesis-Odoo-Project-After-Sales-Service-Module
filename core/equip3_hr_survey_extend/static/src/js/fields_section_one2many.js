console.log('question_master_page_one2many0');
odoo.define('survey.question_master_page_one2many1234', function (require) { 
"use strict";
...
console.log('question_master_page_one2many');
//FieldRegistry.add('question_master_page_one2many', SectionFieldOne2Many);
});
