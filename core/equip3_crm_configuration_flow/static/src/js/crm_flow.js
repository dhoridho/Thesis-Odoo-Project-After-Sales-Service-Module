odoo.define('equip3_crm_configuration_flow.crm_configuration_flow', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var crm_configuration_flow = AbstractAction.extend({
        contentTemplate: "crm_flow_configuration_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('crm_configuration_flow_tag', crm_configuration_flow);
    return crm_configuration_flow;
});