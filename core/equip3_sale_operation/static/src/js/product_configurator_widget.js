...
ProductConfiguratorWidget.include({
    ...
    */
    ...
    _openConfigurator: function (result, productTemplateId, dataPointId) {
        if (!result.mode || result.mode === 'configurator') {
            this._openProductConfigurator({
                    ...
                    default_warehouse_id: this.record.evalContext.parent.warehouse_id,
                    default_is_single_warehouse: this.record.evalContext.parent.is_single_warehouse,
    ...
    _getMainProductChanges: function (mainProduct) {
        // Disinilah tempate memasukan dari wizard ke so line
        // field many2one tulisnya harus {id: xxx}
        console.log('add ke so line cek sini #Y')
        var result = {
            ...
            line_warehouse_id_new: {id:mainProduct.line_warehouse_id_new},
        };
