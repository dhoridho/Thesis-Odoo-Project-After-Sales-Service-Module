        ...
        for obj in self:
            if obj.reservation_id:
                ...
                if obj.service_type != 'internal' and obj.is_chargeable and obj.is_pickup:
                    ...
                    _logger.info("Currency ID==>>>>{}".format(obj.trans_partner_id.partner_id.property_product_pricelist.currency_id.id))
                    invoice_data1 = {
                        # 'name': obj.name,
                    ...
                    product_context = dict(self.env.context, partner_id=obj.trans_partner_id.partner_id.id, date=time.strftime(
                    ...
                    account_move_vals = invoice_data_id1._convert_to_write({name: invoice_data_id1[name] for name in invoice_data_id1._cache})
