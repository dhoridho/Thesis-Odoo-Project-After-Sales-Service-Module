odoo.define('tis_venue_booking.MapRenderer', function (require) {
    'use strict';
    ...
    var ICON_URL = '/tis_venue_booking/static/src/img/markers/';
    var MARKER_COLORS = [
    ...
    var MapRenderer = BasicRenderer.extend({
        ...
        _initLibraryProperties: function (params) {
            if (this.mapLibrary === 'drawing') {
                ...
                this.markers = [];
                this.iconUrl = '/tis_venue_booking/static/src/img/markers/';
        ...
        _initMarkerCluster: function () {
            this.markerCluster = new MarkerClusterer(this.gmap, [], {
                imagePath: '/tis_venue_booking/static/lib/markercluster/img/m',
                gridSize: 20,
                maxZoom: 17
            });
        },
