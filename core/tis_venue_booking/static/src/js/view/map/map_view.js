odoo.define('tis_venue_booking.MapView', function (require) {
    'use strict';

    var BasicView = require('web.BasicView');
    var core = require('web.core');

    var MapModel = require('tis_venue_booking.MapModel');
    var MapRenderer = require('tis_venue_booking.MapRenderer');
    var MapController = require('tis_venue_booking.MapController');
