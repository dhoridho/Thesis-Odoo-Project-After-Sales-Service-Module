...
class EmployeeRace(models.Model):
    ...
    _sql_constraints = [
        ('unique_race_name', 'unique(name)', 'The Race name must be unique!'),
    ]
    ...
    def search_read(self, domain=None, fields=None, offset=0, limit=None, order=None):
        ...
        result = super(EmployeeRace, self).search_read(domain=domain, fields=fields, offset=offset, limit=limit, order=order)
        return result
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        return super(EmployeeRace, self).read_group(domain, fields, groupby, offset=offset, limit=limit, orderby=orderby, lazy=lazy)
    
    @api.model
    def fields_view_get(self, view_id=None, view_type=None,
                        toolbar=True, submenu=True):
        res = super(EmployeeRace, self).fields_view_get(
