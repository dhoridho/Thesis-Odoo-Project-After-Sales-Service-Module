...
class InvoiceTemplates(models.Model):
    _name = "invoice.templates"
    _description = "Invoice Order Templates"

    name = fields.Char(string='Name', required=True)
    invoice_header_ids = fields.Many2many(
            'ir.model.fields',
            'invoice_template_header_model_fields_rel')
    invoice_table_ids = fields.Many2many(
        'ir.model.fields',
        'invoice_template_table_model_fields_rel')
    invoice_footer_ids = fields.Many2many(
        'ir.model.fields',
        'invoice_template_footer_model_fields_rel')
    ...
    invoice_header_sequence_ids = fields.One2many(comodel_name='invoice.template.header', inverse_name='template_id', string='Header')
    invoice_table_sequence_ids = fields.One2many(comodel_name='invoice.template.table', inverse_name='template_id', string='Table')
    invoice_footer_sequence_ids = fields.One2many(comodel_name='invoice.template.footer', inverse_name='template_id', string='Footer')
...
class InvoiceTemplateHeader(models.Model):
    _name = "invoice.template.header"
    _description = "Invoice Template Header"

    template_id = fields.Many2one(comodel_name='invoice.templates', string='Template', required=True, ondelete="cascade")
    field_id = fields.Many2one(comodel_name='ir.model.fields', string='Field')
    sequence = fields.Integer(string='Sequence')

class InvoiceTemplateTable(models.Model):
    _name = "invoice.template.table"
    _description = "Invoice Template Table"

    template_id = fields.Many2one(comodel_name='invoice.templates', string='Template', required=True, ondelete="cascade")
    field_id = fields.Many2one(comodel_name='ir.model.fields', string='Field')
    sequence = fields.Integer(string='Sequence')

class InvoiceTemplateFooter(models.Model):
    _name = "invoice.template.footer"
    _description = "Invoice Template Footer"
