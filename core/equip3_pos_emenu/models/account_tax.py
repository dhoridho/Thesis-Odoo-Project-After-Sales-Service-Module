...
class AccountTax(models.Model):
    ...
    # Copy method from module equip3_accounting_operation to get values without rounding
    def _emenu_compute_all(self, price_unit, currency=None, quantity=1.0, product=None, partner=None, is_refund=False, handle_price_include=True):
        ...
        return {
            ...
            'total_included_round': sign * currency.round(total_included),
            'total_void_round': sign * currency.round(total_void), 
