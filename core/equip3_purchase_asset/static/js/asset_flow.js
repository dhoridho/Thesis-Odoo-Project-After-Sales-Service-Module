odoo.define('equip3_purchase_asset.asset_configuration_flow', function (require){
"use strict";
    var core = require('web.core');
    var AbstractAction = require('web.AbstractAction');
    var session = require('web.session');

    var asset_configuration_flow = AbstractAction.extend({
        contentTemplate: "asset_flow_configuration_action",
        hasControlPanel: !1,
        events: {
    ...
    core.action_registry.add('asset_configuration_flow_tag', asset_configuration_flow);
    return asset_configuration_flow;
});