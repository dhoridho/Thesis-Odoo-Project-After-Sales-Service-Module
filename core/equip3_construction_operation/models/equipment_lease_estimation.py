...
class EquipmentLeaseEstimations(models.Model):
    _name = 'equipment.lease.estimation'
    _description = "Equipment Lease Estimation"
    _rec_name = "date"
    ...
    def _sequence_ref(self):
        for line in self:
            no = 0
            line.sr_no = no
            for l in line.budget_carry_over_id.budget_carry_equipment_ids:
                no += 1
                l.sr_no = no