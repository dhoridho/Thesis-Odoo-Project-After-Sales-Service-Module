odoo.define('equip3_mining_reports.mining_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var mining_flow = AbstractAction.extend({
            contentTemplate: "mining_flow_wizard_action_one",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('mining_flow_tag', mining_flow);
        return mining_flow;
    });