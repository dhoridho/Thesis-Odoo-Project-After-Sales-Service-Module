...
class ProductProduct(models.Model):
    ...
    image_chat = fields.Image('Compressed Image', compute='compute_image_chat', store=True, attachment=True)
    ...
    def _recreate_image_chat(self):
        ...
        prod_ids = self.search(['|', ('product_tmpl_id', 'in', tmpl_ids), ('image_variant_1920', '!=', False)])
