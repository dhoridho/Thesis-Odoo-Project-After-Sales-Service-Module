odoo.define('equip3_accounting_flow.accounting_configuration_flow', function (require){
    "use strict";
        var core = require('web.core');
        var AbstractAction = require('web.AbstractAction');
        var session = require('web.session');
    
        var accounting_configuration_flow = AbstractAction.extend({
            contentTemplate: "accounting_flow_configuration_action",
            hasControlPanel: !1,
            events: {
        ...
        core.action_registry.add('accounting_configuration_flow_tag', accounting_configuration_flow);
        return accounting_configuration_flow;
    });