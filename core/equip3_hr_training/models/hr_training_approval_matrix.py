...
class TrainingApprovalMatrix(models.Model):
    ...
    training_required = fields.Selection([('yes', 'Yes'), ('no', 'No')], string="Is Training Required")
    ...
    def search_read(self, domain=None, fields=None, offset=0, limit=None, order=None):
        ...
        result = super(TrainingApprovalMatrix, self).search_read(domain=domain, fields=fields, offset=offset, limit=limit, order=order)
        return result
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        return super(TrainingApprovalMatrix, self).read_group(domain, fields, groupby, offset=offset, limit=limit, orderby=orderby, lazy=lazy)
...
class TrainingApprovalMatrixline(models.Model):
    ...
    _description = "Training Approval Matrix Line"
