...

{
    ...
    """,
    "depends": ["base", 'stock', 'hotel_restaurant', 'hotel_housekeeping', 'sale_enhancement', 'coupon'],
    "init_xml": [],
    "demo_xml": [
    ],
    "data": [
        ...
        'data/reservation_confirmation_mail.xml',
        ...
        'report/hotel_reservation_reports_pdf.xml',
